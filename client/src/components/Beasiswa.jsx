...
const Beasiswa = (props) => {
  return (
    <div className="bg-white rounded-xl shadow-lg flex flex-col p-6 my-8 min-w-max w-full lg:max-w-md">
      <div className="flex flex-wrap max-w-full md:w-2/3 gap-2 pb-6 lg:mr-24 md:justify-start justify-center">
      ...
      <p className="bg-gray rounded-full px-6 py-2 font-semibold text-green">
      ...
      <div className="flex items-center justify-center mt-6 ">
        <a
          className="transition ease-in-out bg-orange tracking-wide shadow-[0_7px_2px_-2px_rgba(0,0,0,0.3)] rounded-xl w-fit py-2 px-4 text-white font-semibold
