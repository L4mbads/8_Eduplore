...
const options = [
  [
    ...
    {
      label: "Indonesian International Student Mobility Awards (IISMA)",
    ...
    <div className="relative flex flex-col w-full items-start bg-gradient-to-b from-blue to-transparent from-30% to-65% min-h-screen pb-16">
      ...
      <div className="flex flex-col gap-y-12 w-full md:px-36 px-2 z-10">
        <div className="grow bg-white rounded-xl p-10 md:pr-36 shadow-lg">
          ...
          <p className="text-xl">
            Peningkatan skill secara terpisah untuk CV, Esai, dan interview
            dengan teori sekaligus praktik langsung
          </p>
        </div>
        <div className="grow bg-white rounded-xl p-10 shadow-lg grid grid-cols-1 gap-y-6 lg:grid-cols-3 gap-x-6 items-start justify-items-center w-full">
          ...
          <div className="bg-gray p-4 rounded-xl w-full flex flex-col h-full max-w-[400px]">
            <h2 className="font-bold text-xl pb-6 text-center">CV BOOST</h2>
            <p className="text-center flex-grow">
              CV Boost yang berisikan tips & trick, proofreading, dan feedback
              terkait CV yang dibuat.
            </p>
            <div className="flex justify-center mt-auto">
              <button
                className={`transition w-full max-w-[250px] ${
                  packet.boost == "cvboost" ? "bg-orange-60" : "bg-orange"
                } rounded-xl mx-6 mt-6 mb-4 shadow-lg text-white font-bold text-3xl tracking-widest hover:bg-orange-80 hover:scale-110`}
          ...
          {/* Esai Boost */}
          <div className="bg-gray p-4 rounded-xl w-full flex flex-col h-full max-w-[400px]">
            <h2 className="font-bold text-xl pb-6 text-center">ESAI BOOST</h2>
            <p className="text-center flex-grow">
              Esai Boost yang berisikan tips & trick, proofreading, dan feedback
              terkait esai yang dibuat.
            </p>
            <div className="flex justify-center mt-auto">
              <button
                className={`transition w-full max-w-[250px] ${
                  packet.boost == "esaiboost" ? "bg-orange-60" : "bg-orange"
                } rounded-xl mx-6 mt-6 mb-4 shadow-lg text-white font-bold text-3xl tracking-widest hover:bg-orange-80 hover:scale-110`}
          ...
          <div className="bg-gray p-4 rounded-xl w-full flex flex-col h-full max-w-[400px]">
            ...
            <p className="text-center flex-grow">
              Interview Boost yang berisikan tips & trick, mockup interview,
              feedback terkait performa dari user.
            </p>
            <div className="flex justify-center mt-auto">
              <button
                className={`transition w-full max-w-[250px] ${
                  packet.boost == "interviewboost"
                    ? "bg-orange-60"
                    : "bg-orange"
                } rounded-xl mx-6 mt-6 mb-4 shadow-lg text-white font-bold text-3xl tracking-widest hover:bg-orange-80 hover:scale-110`}
        ...
        <div className="grow bg-white flex flex-col items-left justify-center rounded-xl p-10 shadow-lg">
          <h2 className="text-2xl font-bold pb-4">PILIH TANGGAL</h2>
          <input
            class="shadow appearance-none border-2 w-full  rounded-xl grow py-2 mb-2 px-3 leading-tight focus:outline-none focus:shadow-outline border-blue"
            id="date"
            type="date"
            placeholder=""
