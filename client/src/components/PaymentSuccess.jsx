    ...
    return (
        <div className='w-screen h-screen flex items-center justify-center bg-white'>
            <div className=" flex flex-col h-fit items-center justify-start">
                ...
                <img src="../src/assets/checkmark.svg" alt="checkmark" className={`my-8 transition-all duration-500 ${doAnimate ? 'scale-100' : 'scale-0'}`} />
                <div className='w-96'>
                ...
                <button className="transition bg-orange rounded-xl py-4 px-14 shadow-lg text-white font-bold text-3xl tracking-wide hover:bg-orange-80 hover:scale-110"
                    onClick={() => navigate('/')}
                >
                    Mengerti
                </button>
